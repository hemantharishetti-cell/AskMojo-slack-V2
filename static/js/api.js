...
class ApiClient {
    ...
    async regenerateDescription(logId) {
        return this.request(`/api/v1/admin/logs/uploads/${logId}/regenerate-description`, {
            method: 'POST'
        });
    }

    async regenerateDocumentDescription(documentId) {
        return this.request(`/api/v1/admin/documents/${documentId}/regenerate-description`, {
            method: 'POST'
        });
    }
}
