...
if __name__ == "__main__":
    ...
    port = 8000 if settings.environment == "development" else settings.port
    if settings.environment == "development" and settings.port != 8000:
        print(f"Development mode detected. Overriding configured port {settings.port} -> 8000")
